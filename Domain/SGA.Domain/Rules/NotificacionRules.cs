...
namespace SGA.Domain.Rules
{
    public static class NotificacionRules
    {
        ...
        public static Result<Notificacion> CrearIncidenciaAdministrador(
            ...
            DateTime fechaHora)
        {
            var descripcionValida = CommonValidationRules.Requerido(
            ...
            DateTime fechaHora)
        {
            var validacion = CommonValidationRules.Combinar(
                CommonValidationRules.IdValido(usuarioTransporteId, "usuario destinatario"),
                CommonValidationRules.Requerido(tipo, "tipo de notificacion"),
                CommonValidationRules.Requerido(titulo, "titulo de notificacion"),
                CommonValidationRules.Requerido(mensaje, "mensaje de notificacion"),
                CommonValidationRules.FechaDefinida(fechaHora, "notificacion"));
